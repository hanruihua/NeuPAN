...
def main(
    ...
    # neupan_planner.update_adjust_parameters(q_s=[0.5, 0.6, 0.1], p_u=1.0, eta=10.0, d_max=1.0, d_min=0.1) # for vector q_s, q_s yaml file should be modified accordingly 3d list/array/tensor
